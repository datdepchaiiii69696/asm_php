...
<form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
                ...
                <div class="collapse show" id="collapseProductInfo">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="product-title-input" placeholder="Tên sản phẩm" name="name" value="{{ old('name', $product->name) }}">
                        </div>
                        <!-- Product Price -->
                        <div class="mb-3">
                            <label for="product-price-input" class="form-label">Giá</label>
                            <input type="text" class="form-control" id="product-price-input" placeholder="Giá sản phẩm" name="price" value="{{ old('price', $product->price) }}">
                        </div>
                        <!-- Product Sale Price -->
                        <div class="mb-3">
                            <label for="product-sale-price-input" class="form-label">Giá sale</label>
                            <input type="text" class="form-control" id="product-sale-price-input" placeholder="Giá giảm" name="price_sale" value="{{ old('price_sale', $product->price_sale) }}">
                        </div>
                        <!-- Product Description -->
                        <div class="mb-3">
            ...
            <!-- Product Variants -->
            <div class="card shadow mb-4">
                <a href="#collapseProductVariants" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <a href="#collapseStatus" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                ...
                <div class="collapse show" id="collapseStatus">
                    <div class="card-body">
                        ...
                        <select class="form-control form-select-lg mb-3" id="choices-publish-status-input" aria-label="Default select example" name="status">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="form-group custom-control custom-checkbox small col-md-3">
                                <input type="checkbox" class="custom-control-input" id="customCheck-{{$key}}" name="{{$key}}" {{ $product->$key ? 'checked' : '' }}>
